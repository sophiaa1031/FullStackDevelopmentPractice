...
@Component({
  selector: 'app-user-compare-company',
  templateUrl: './user-compare-company.component.html',
  styleUrls: ['./user-compare-company.component.css']
})
export class UserCompareCompanyComponent implements OnInit {
  rangeValue: number = 3;
    average: number = 0;
